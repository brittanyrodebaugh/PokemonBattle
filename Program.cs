...
namespace PokemonBattle
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            Ability Ember = new Ability("Ember", 40, 100, "Ember deals damage and has a 10% chance of burning the target.");
            ...
            Pokemon playerPokemon = bulbasaur;
            Pokemon opponentPokemon = bulbasaur;
